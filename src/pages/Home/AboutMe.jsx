        ...
        <section id="about" className="about-me">
            <div className="about-me-content">
                <div className="about-me-text">
                    ...
                    <p>
                        <strong>Professional Bachelor’s Degree in Software Systems</strong><br />
                        Kauno kolegija – Higher Education Institution, Lithuania<br />
                        Equivalent to a UK Bachelor's Degree<br />
                        Kaunas, Lithuania<br />
                        September 2020 – January 2024
                    </p>
                    <span className="section-heading">Experience</span>
                    <p>
                        <strong>Junior .NET Developer Intern</strong><br />
                        UAB SoftDent<br />
                        Kaunas, Lithuania<br />
